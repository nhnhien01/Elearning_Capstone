  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20 mt-8">
      <div className="flex justify-start">
        <Link
          to="/"
          className="flex items-center gap-2 bg-gray-950 text-amber-400 px-4 py-3 rounded-xl text-xs font-black uppercase tracking-wider border border-gray-950 hover:bg-gray-800 transition-all"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-[2rem] border-[3px] border-slate-900 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center">
          ...
          >
            <img
              src={
                profile.hinhAnh
                  ? profile.hinhAnh.startsWith("http")
                    ? profile.hinhAnh
                    : `https://elearning-capstone.onrender.com${profile.hinhAnh}`
                  : `https://ui-avatars.com/api/?name=${profile.hoTen}`
              }
              ...
              alt="Avatar"
            />
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/40 rounded-3xl text-white font-black text-[10px] uppercase">
              Thay đổi
            </div>
          </div>
          <input
          ...
          <span className="bg-amber-400 text-slate-950 px-4 py-1 rounded-full text-[10px] font-black uppercase mt-4 border-2 border-slate-900 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            Administrator
          </span>
        </div>
        ...
        <div className="md:col-span-2 bg-white p-8 rounded-[2rem] border-[3px] border-slate-900 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          {msg.text && (
            <div
              className={`p-3 mb-6 rounded-2xl font-black text-center text-[11px] uppercase tracking-wider border-2 border-slate-900 ${msg.type === "success" ? "bg-emerald-50 text-emerald-700" : "bg-red-50 text-red-700"}`}
            >
              {msg.text}
            </div>
          )}
          <form onSubmit={handleUpdate} className="space-y-5">
            ...
            <div>
              ...
              <input
                disabled
                className="w-full p-3.5 border-2 border-slate-900 rounded-2xl font-bold bg-slate-200 text-slate-500 cursor-not-allowed"
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full p-3.5 border-2 border-slate-900 rounded-2xl font-bold bg-white focus:bg-slate-50 transition-all outline-none"
                placeholder="••••••••"
                onChange={(e) =>
              ...
              <button
                type="button"
                className="absolute right-4 top-10 text-slate-900"
            ...
            <button
              type="submit"
              className="w-full py-4 bg-slate-950 text-amber-400 font-black rounded-2xl border-2 border-slate-900 hover:bg-slate-800 transition-all flex items-center justify-center gap-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-[2px] active:translate-y-[2px]"
            >
